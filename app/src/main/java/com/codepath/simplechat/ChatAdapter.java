...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MessageViewHolder> {
    ...
    // checks if a message was sent by me
    private boolean sentByMe(int position) {
    ...
    //create onCreateViewHolder and onBindViewHolder later (covered in the next few chapters...)
